...
Root: "HKCR"; Subkey: "*\shell\IndetectablesToolkit\command"; ValueType: string; ValueName: ""; ValueData: """{#MyAppBinsFolder}\sendto\sendto.exe"" /C /D ""{#MyAppBinsFolder}\sendto\sendto"" ""%1"""; Components: "extras\contextmenu"; Flags: uninsdeletekey;
