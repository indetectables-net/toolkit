...
[Icons]
Name: "{group}\SysAnalyzer"; Filename: "{#MyAppToolsFolder}\Monitor\SysAnalyzer\sysAnalyzer.exe"; WorkingDir: "{#MyAppToolsFolder}\Monitor\SysAnalyzer"; Components: "monitor\sysanalyzer";   Check: not Is64BitInstallMode; 
