...
; mitmproxy
[Components]
Name: "network\mitmproxy"; Description: "mitmproxy"; Types: full;

[Files]
Source: "{#MySrcDir}\toolkit\Network\mitmproxy\*"; DestDir: "{#MyAppToolsFolder}\Network\mitmproxy"; Components: "network\mitmproxy"; Flags: ignoreversion recursesubdirs createallsubdirs;
...
Name: "{#MyAppBinsFolder}\sendto\sendto\Network\mitmweb"; Filename: "{#MyAppToolsFolder}\Network\mitmproxy\mitmweb.exe"; WorkingDir: "{#MyAppToolsFolder}\Network\mitmproxy"; Components: "network\mitmproxy";
