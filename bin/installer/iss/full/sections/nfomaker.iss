; Main section
[Files]
Source: "{#MySrcDir}\toolkit\NFOMaker\desktop.ini"; DestDir: "{#MyAppBinsFolder}\sendto\sendto\NFOMaker"; Components: "nfomaker"; Attribs: hidden system; Flags: ignoreversion; 
Source: "{#MySrcDir}\toolkit\NFOMaker\folder.ico"; DestDir: "{#MyAppBinsFolder}\sendto\sendto\NFOMaker"; Components: "nfomaker"; Attribs: hidden; Flags: ignoreversion; 
