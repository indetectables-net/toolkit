...
[Icons]
Name: "{group}\{#MyAppName}\FLOSS x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\FLOSS\floss.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\FLOSS"; Components: "other\floss"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\floss.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Other\FLOSS x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\FLOSS\floss.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\FLOSS"; Components: "other\floss"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\floss.ico"; 
...
[Icons]
Name: "{group}\{#MyAppName}\Process-Dump"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Process-Dump\pd32.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Process-Dump"; Components: "other\processdump";  IconFilename: "{#MyAppToolsIconsFolder}\process-dump.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Other\Process-Dump"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Process-Dump\pd32.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Process-Dump"; Components: "other\processdump";  IconFilename: "{#MyAppToolsIconsFolder}\process-dump.ico"; 

[Icons]
Name: "{group}\{#MyAppName}\Process-Dump x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Process-Dump\pd64.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Process-Dump"; Components: "other\processdump"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\process-dump.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Other\Process-Dump x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Process-Dump\pd64.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Process-Dump"; Components: "other\processdump"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\process-dump.ico"; 
...
[Icons]
Name: "{group}\{#MyAppName}\Strings"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Strings\strings.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Strings"; Components: "other\strings";  IconFilename: "{#MyAppToolsIconsFolder}\strings.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Other\Strings"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Strings\strings.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Strings"; Components: "other\strings";  IconFilename: "{#MyAppToolsIconsFolder}\strings.ico"; 

[Icons]
Name: "{group}\{#MyAppName}\Strings x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Strings\strings64.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Strings"; Components: "other\strings"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\strings.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Other\Strings x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Other\Strings\strings64.exe"; WorkingDir: "{#MyAppToolsFolder}\Other\Strings"; Components: "other\strings"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\strings.ico"; 
