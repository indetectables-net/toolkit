...
[Icons]
Name: "{group}\{#MyAppName}\CAPA x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Analysis\CAPA\capa.exe"; WorkingDir: "{#MyAppToolsFolder}\Analysis\CAPA"; Components: "analysis\capa"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\capa.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Analysis\CAPA x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Analysis\CAPA\capa.exe"; WorkingDir: "{#MyAppToolsFolder}\Analysis\CAPA"; Components: "analysis\capa"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\capa.ico"; 
