...
[Icons]
Name: "{group}\{#MyAppName}\HollowsHunter x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Monitor\HollowsHunter\hollows_hunter.exe"; WorkingDir: "{#MyAppToolsFolder}\Monitor\HollowsHunter"; Components: "monitor\hollowshunter"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\hollowshunter.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Monitor\HollowsHunter x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Monitor\HollowsHunter\hollows_hunter.exe"; WorkingDir: "{#MyAppToolsFolder}\Monitor\HollowsHunter"; Components: "monitor\hollowshunter"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\hollowshunter.ico"; 
...
[Icons]
Name: "{group}\{#MyAppName}\PE-sieve x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Monitor\PE-sieve\pe-sieve.exe"; WorkingDir: "{#MyAppToolsFolder}\Monitor\PE-sieve"; Components: "monitor\pesieve"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\pe-sieve.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\Monitor\PE-sieve x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\Monitor\PE-sieve\pe-sieve.exe"; WorkingDir: "{#MyAppToolsFolder}\Monitor\PE-sieve"; Components: "monitor\pesieve"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\pe-sieve.ico"; 
