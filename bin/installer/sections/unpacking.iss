...
[Icons]
Name: "{group}\{#MyAppName}\De4Dot x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\UnPacking\De4Dot\de4dot-x64.exe"; WorkingDir: "{#MyAppToolsFolder}\UnPacking\De4Dot"; Components: "unpacking\de4dot"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\de4dot.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\UnPacking\De4Dot x64"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\UnPacking\De4Dot\de4dot-x64.exe"; WorkingDir: "{#MyAppToolsFolder}\UnPacking\De4Dot"; Components: "unpacking\de4dot"; Check: Is64BitInstallMode; IconFilename: "{#MyAppToolsIconsFolder}\de4dot.ico"; 

[Icons]
Name: "{group}\{#MyAppName}\De4Dot"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\UnPacking\De4Dot\de4dot.exe"; WorkingDir: "{#MyAppToolsFolder}\UnPacking\De4Dot"; Components: "unpacking\de4dot";  IconFilename: "{#MyAppToolsIconsFolder}\de4dot.ico"; 
Name: "{#MyAppBinsFolder}\sendto\sendto\UnPacking\De4Dot"; Filename: "{sys}\cmd.exe /K {#MyAppToolsFolder}\UnPacking\De4Dot\de4dot.exe"; WorkingDir: "{#MyAppToolsFolder}\UnPacking\De4Dot"; Components: "unpacking\de4dot";  IconFilename: "{#MyAppToolsIconsFolder}\de4dot.ico"; 
